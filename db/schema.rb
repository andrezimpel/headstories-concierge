...
ActiveRecord::Schema.define(version: 20150502150909) do
  ...
  create_table "clients", force: :cascade do |t|
    ...
    t.boolean  "formally",               limit: 1
    t.string   "gender",                 limit: 255
    t.boolean  "consent",                limit: 1
    ...
    t.string   "consent_token",          limit: 255
  end
